...
namespace RpgApi.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            (
                new Arma() { Id = 1, Nome = "Pistola", Dano = 45, PersonagemId = 1 },
                new Arma() { Id = 2, Nome = "Escopeta", Dano = 90, PersonagemId = 2 },
                new Arma() { Id = 3, Nome = "Submetralhadora", Dano = 70, PersonagemId = 3 },
                new Arma() { Id = 4, Nome = "Fuzil", Dano = 80, PersonagemId = 4 },
                new Arma() { Id = 5, Nome = "Lançador de Foguetes", Dano = 100, PersonagemId = 5 },
                new Arma() { Id = 6, Nome = "Revólver", Dano = 50, PersonagemId = 6 },
                new Arma() { Id = 7, Nome = "Faca", Dano = 30, PersonagemId = 7 }
            );
